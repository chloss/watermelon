		...
		echo '<div id="sync1-'.esc_attr($ran).'" class="owl-carousel owl-theme">';
				...
				<?php while($catquery->have_posts()) : $catquery->the_post(); 
					...
					if(isset( $feat_image_url ) && $feat_image_url!='' )
					{
						...
						$feat_image_url = esc_url(BTTK_FILE_URL).'/public/css/image/no-featured-img.png';
					}
					?>
					<div class="item">
...
// Widget Backend 
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Category:', 'blossomthemes-toolkit' ); ?></label> 
        ...
        <p>
            ...
            <div class="example-text"><?php _e('Total number of posts available in the selected category will be the maximum number of slides.','blossomthemes-toolkit');?></div>
        </p>
