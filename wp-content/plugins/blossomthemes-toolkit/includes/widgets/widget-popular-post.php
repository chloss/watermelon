                ...
                ?>
                    <li>
                        ...
                        if( $show_thumbnail && !has_post_thumbnail() ){
                            echo '<a '.$target.' href="'.get_the_permalink().'" class="post-thumbnail"><img src="'.esc_url(BTTK_FILE_URL).'/public/css/image/no-featured-img.png"></a>';
                        }
                        ?>
                        <div class="entry-header">
                            ...
                            if( $show_date  ){ ?>
                                <div class="entry-meta"> 
                                    <?php $obj = new BlossomThemes_Toolkit_Functions;
                                    $obj->bttk_posted_on(); ?>
                                </div>
                            <?php
                            }
