...
class Kalon_Featured_Post extends WP_Widget {
        ...
        if( $qry->have_posts() ){
            ...
            ?>
                ...
                <div class="text-holder">
                    <?php echo wpautop( kalon_excerpt( get_the_content(), $excerpt_char, '...', false, false ) );?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'excerpt_char' ); ?>"><?php esc_html_e( 'Excerpt Character', 'kalon' ); ?></label> 
