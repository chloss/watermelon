                    ...
                    <article class="post">
                        <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                            <div class="post-thumbnail">
                                <a href="<?php the_permalink();?>" class="post-thumbnail">
                                    <?php the_post_thumbnail( 'kalon-recent-post', array( 'itemprop' => 'image' ) );?>
                                </a>
                            </div>
                        <?php }?>
                        <header class="entry-header">
                                    ...
                                    <?php if( $show_date ){ ?>
                                        ...
                                        <time datetime="<?php printf( __( '%1$s', 'kalon' ), get_the_date('Y-m-d') ); ?>">
                                        <?php printf( __( '%1$s', 'kalon' ), get_the_date('F jS, Y') ); ?></time></a></span>
                                    <?php } ?>
                                    </div>
                         </header>                       
                    </article>        
