...
function kalon_customize_preview_js() {
	...
	wp_enqueue_script( 'kalon_customizer', get_template_directory_uri() . '/js' . $build . '/customizer' . $suffix . '.js', array( 'customize-preview' ), '20130508', true );
}
...
function kalon_customize_scripts() {
    wp_enqueue_style( 'kalon-admin-style',get_template_directory_uri().'/inc/css/admin.css', '1.0', 'screen' );    
