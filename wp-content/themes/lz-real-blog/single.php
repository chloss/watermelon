	    	...
	    	<section id="post_section" class="">
				...
				while ( have_posts() ) : the_post();
					...
					the_post_navigation( array(
						'prev_text' => '<span class="screen-reader-text">' . __( 'Previous Post', 'lz-real-blog' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Previous', 'lz-real-blog' ) . '</span>',
						'next_text' => '<span class="screen-reader-text">' . __( 'Next Post', 'lz-real-blog' ) . '</span><span aria-hidden="true" class="nav-subtitle">' . __( 'Next', 'lz-real-blog' ) . '</span> ',
					) );
