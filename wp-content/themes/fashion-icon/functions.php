...
if( ! function_exists( 'fashion_icon_scripts' ) ):
	function fashion_icon_scripts() {
        ...
        wp_enqueue_style( 'fashion-icon-parent', get_template_directory_uri() . '/style.css', array( 'animate' ) );
		wp_enqueue_style( 'fashion-icon', get_stylesheet_directory_uri(). '/style.css' , array( 'fashion-icon-parent' ) , $version );
...
function fashion_icon_customize_register( $wp_customize ) {
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( '%1$sDocumentation Link:%2$s %3$sClick here.%4$s', 'fashion-icon' ), '<strong>', '</strong>' , '<a href="' . esc_url( 'https://blossomthemes.com/fashion-icon-free-theme-documentation/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
...
function blossom_fashion_category(){
	if ( 'post' === get_post_type() ) {
		...
		$categories_list = get_the_category_list( esc_html__( ' ', 'fashion-icon' ) );
		if ( $categories_list ) {
...
function fashion_icon_dynamic_css(){    
    ...
    #primary .post .entry-header .entry-title a:hover, #primary .post .entry-header .entry-title a:focus, .banner .text-holder .title a:hover, .banner .text-holder .title a:focus,
    ...
    .woocommerce div.product .entry-summary .variations_form .single_variation_wrap .button:hover, .woocommerce div.product .entry-summary .variations_form .single_variation_wrap .button:focus, 
...
add_action( 'wp_head', 'fashion_icon_dynamic_css', 100 );
    ...
    <div class="footer-b">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/downloads/fashion-icon-free-wordpress-theme' ) .'" rel="author" target="_blank">' . esc_html__( ' Fashion Icon', 'fashion-icon' ) . '</a>' . esc_html__( ' by Blossom Themes.', 'fashion-icon' );                                
